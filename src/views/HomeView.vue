<template>
    <app-page>
        ...
        <template #body>
            <v-card-item>
                <v-form class="bg-blue-grey-darken-2 d-flex flex-column ga-2 pa-10 rounded-lg" @submit.prevent="sendData">
                    <v-text-field 
                      clearable 
                      variant="outlined"
                      label="Company"
                    ...
                    <v-text-field 
                      ...
                      v-model="phonenumber"
                    ></v-text-field>
                    <v-btn type="submit" text="Create" color="primary w-50 align-self-center"></v-btn>
                </v-form>
            </v-card-item>
        </template>
    </app-page>
